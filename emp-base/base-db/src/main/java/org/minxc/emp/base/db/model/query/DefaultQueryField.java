package org.minxc.emp.base.db.model.query;

import org.minxc.emp.base.api.constant.StringConstants;
import org.minxc.emp.base.api.query.QueryField;
import org.minxc.emp.base.api.query.QueryOperation;
import org.minxc.emp.base.core.util.time.DateFormatUtil;
...
public class DefaultQueryField implements QueryField {
    ...
    // 比较符
    private QueryOperation compare;
    // 比较值
    ...
    public DefaultQueryField(String field, QueryOperation compare, Object value) {
        this.field = field;
        this.compare = compare;
        this.value = value;

        if (QueryOperation.IN.equals(compare) || QueryOperation.NOT_IN.equals(compare)) {
    ...
    public void setCompare(QueryOperation compare) {
        this.compare = compare;
    }

    public String getSql() {
        if (compare == null) {
            compare = QueryOperation.EQUAL;
        }
        String fieldParam;
        if (field.indexOf(".") > -1) {
