...
public enum QueryOperation {
    ...
    private QueryOperation(String val, String op, String desc, String[] supports) {
        this.val = val;
        this.op = op;
        this.desc = desc;
     ...
     * @since 1.0.0
     */
    public static QueryOperation getByOP(String op) {
        for (QueryOperation queryOP : values()) {
    ...
    public static QueryOperation getByVal(String val) {
        for (QueryOperation queryOP : values()) {
