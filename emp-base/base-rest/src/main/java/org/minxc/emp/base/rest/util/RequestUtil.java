package org.minxc.emp.base.rest.util;
...
public class RequestUtil {
    ...
    public static void handleRequestParam(HttpServletRequest request, DefaultQueryFilter queryFilter) {
        ...
        while (paramNames.hasMoreElements()) {
            ...
            if (condition.length() == 1) {
                ...
                QueryOperation queryOP = QueryOperation.getByVal(condition.substring(1, condition.length()));
     ...
     * @return QueryOP
     */
    public static QueryOperation getCompare(String type) {
        // 字符串 精准匹配
        if ("S".equals(type)) {
        ...
        // date begin
            ...
            return QueryOperation.GREAT_EQUAL;
        }
        // date end
        else if ("DG".equals(type)) {
            return QueryOperation.LESS_EQUAL;
        }
        // in
