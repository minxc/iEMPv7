...
import org.minxc.emp.system.api.constant.EnvironmentConstant;
import org.minxc.emp.system.api.service.PropertyService;
import org.minxc.emp.system.core.dao.SysPropertiesDao;
...
public class SysPropertiesManagerImpl extends BaseManager<String, SystemProperties> implements SystemPropertiesManager, PropertyService {
    @Resource
    ...
    @Override
    public boolean isExist(SystemProperties sysProperties) {
